...
public class SenderController {
    ...
    // 模板id
    private static final String TPL_ID = "xx-RUfbo";
    ...
    public String sendMsg(String openid) {
        // getAccessToken
        String getAccessUrl = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=" + APPID + "&secret=" + APPSECRET;
    ...
    private Map<String, Object> buildParam(String openId) {
        ...
        paramMap.put("template_id", TPL_ID);
